...
# C# SDK for the FINBOURNE Insights API
...
This is the C# SDK for the FINBOURNE Insights API, part of the [LUSID by FINBOURNE](https://www.finbourne.com/lusid-technology) platform. To use it you'll need a LUSID account - [sign up for free at lusid.com](https://www.lusid.com/app/signup).
...
The NuGet package for the FINBOURNE Insights API SDK can installed from https://www.nuget.org/packages/Finbourne.Insights.Sdk using the following

```
$ dotnet add package Finbourne.Insights.Sdk
```
