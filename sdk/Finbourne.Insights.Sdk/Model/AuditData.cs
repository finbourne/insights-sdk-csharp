...
namespace Finbourne.Insights.Sdk.Model
{
    ...
    public partial class AuditData : IEquatable<AuditData>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Action != null && this.Action.Length > 64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Action, length must be less than 64.", new [] { "Action" });
            }
            ...
            if (this.Category != null && this.Category.Length > 16)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Category, length must be less than 16.", new [] { "Category" });
            }
            ...
            if (this.UserId != null && this.UserId.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UserId, length must be less than 128.", new [] { "UserId" });
            }
            ...
            // DetailsType (string) maxLength
            if (this.DetailsType != null && this.DetailsType.Length > 16)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DetailsType, length must be less than 16.", new [] { "DetailsType" });
            }

            // DetailsType (string) minLength
            if (this.DetailsType != null && this.DetailsType.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DetailsType, length must be greater than 0.", new [] { "DetailsType" });
            }
