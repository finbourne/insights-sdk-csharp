...
namespace Finbourne.Insights.Sdk.Model
{
    ...
    public partial class AccessEvaluationLog : IEquatable<AccessEvaluationLog>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // RequiredLicencePolicyId (string) maxLength
            if (this.RequiredLicencePolicyId != null && this.RequiredLicencePolicyId.Length > 64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RequiredLicencePolicyId, length must be less than 64.", new [] { "RequiredLicencePolicyId" });
            }

            // RequiredLicencePolicyId (string) minLength
            if (this.RequiredLicencePolicyId != null && this.RequiredLicencePolicyId.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RequiredLicencePolicyId, length must be greater than 1.", new [] { "RequiredLicencePolicyId" });
            }
