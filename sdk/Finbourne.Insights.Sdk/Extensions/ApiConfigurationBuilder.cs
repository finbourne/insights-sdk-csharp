    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { "BaseUrl", "FBN_FINBOURNE-INSIGHTS_API_URL" },
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-INSIGHTS_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-insights_api_url"),
